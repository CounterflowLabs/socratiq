...
| Provider 类型 | 协议规范 | 示例 |
|--------------|---------|------|
| **Anthropic 原生** | Anthropic Messages API | Claude Sonnet/Haiku/Opus |
...
class UserLLMConfig(BaseModel):
    ...
    # 按用途指定模型
    primary_model: str          # 主交互模型，如 "anthropic/claude-sonnet-4-20250514"
    light_model: str            # 轻量任务，如 "openai/gpt-4o-mini" 或 "ollama/qwen2.5"
    strong_model: str | None    # 复杂推理（可选），如 "anthropic/claude-opus-4-20250514"
...
LLM_STRONG_MODEL=anthropic/claude-opus-4-20250514
